package com.vickyfebiola_18104022.praktikum10.adapter
...
import com.vickyfebiola_18104022.praktikum10.QuoteAddUpdateActivity
import com.vickyfebiola_18104022.praktikum10.R
import com.vickyfebiola_18104022.praktikum10.data.Quote
import com.vickyfebiola_18104022.praktikum10.databinding.ItemQuoteBinding
...
class QuoteAdapter(private val activity: Activity): RecyclerView.Adapter<QuoteAdapter.QuoteViewHolder>() {
    ...
    inner class QuoteViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(quote: Quote, position: Int) {
            ...
            binding.tvItemPublisher.text = quote.publisher
